...
public class PlaylistFragment extends Fragment implements AdapterView.OnItemClickListener,RecyclerViewClickInterface,View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        myRV = view.findViewById(R.id.playlistRV);
        myRV.setLayoutManager(new LinearLayoutManager(getContext()));
        myRV.setHasFixedSize(true);
        Log.i("LIST_COUNT: ",DataImporter.list.size()+"");
