 ...
 * under the License.
 */
//COMMENT: FUNCTION 100% FROM SPOTIFY SDK, I ONLY USED THIS FOR CONNECTING TO THE OFFICIAL SPOTIFY APP
...
public class RemotePlayerActivity extends FragmentActivity {
    ...
    MyDB db;
    MyHelper myHelper;
    static public float chorusTime = 0;
            ...
            new Subscription.EventCallback<PlayerState>() {
                ...
                public void onEvent(PlayerState playerState) {
                    ...
                    if (playerState.track != null) {
                        ...
                        Log.i("CHORUS_CHECK_1",playerState.track.name.toString());
                        Log.i("CHORUS_CHECK_2",db.getSelectedData(playerState.track.name.toString()).toString());
                        Log.i("CHORUS_CHECK_3",db.getSelectedData(playerState.track.name.toString()).get(8));
                        chorusTime = Float.parseFloat(db.getSelectedData(playerState.track.name).get(8));
                    }
                    // Update progressbar
...
//        onDisconnected();
    ...
    private void onConnected() {
        ...
        Intent i = new Intent(RemotePlayerActivity.this, MainActivity.class);
        startActivity(i);
    }
    ...
    public void onPlayPlaylistButtonClicked(View view) {
        playUri("spotify:playlist:4TqVtrCBIyUhHOKsI3peZn");
    }
    ...
    public void onGetCollectionStateClicked(View view) {
        mSpotifyAppRemote
                ...
                .setResultCallback(
                        libraryState ->
                                Log.i("PlayerContextaaaaaaaa", gson.toJson((libraryState))));
